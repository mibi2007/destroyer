...
class LocalStorageSettingsPersistence extends SettingsPersistence {
  ...
  @override
  Future<bool> getUseGamepad() async {
    final prefs = await instanceFuture;
    return prefs.getBool('useGamepad') ?? false;
  }

  @override
  Future<void> saveUseGamepad(bool useGamepad) async {
    final prefs = await instanceFuture;
    await prefs.setBool('useGamepad', useGamepad);
  }
}
